...
public class JobRepo {
	...
	public JobRepo() {
		...
		jobs.add(new JobPosts(2, "Frontend Developer", "Experience in building responsive web applications using React",
		...
		jobs.add(new JobPosts(8, "Cybersecurity Analyst", "Protect computer systems and networks from cyber threats",
						4, List.of("Cybersecurity", "Network Security", "Incident Response")));

		// Full Stack Developer Job Post
		jobs.add(new JobPosts(9, "Full Stack Developer", "Experience in both front-end and back-end development",
				5, List.of("JavaScript", "Node.js", "React", "Spring", "MongoDB")));

		// Cloud Architect Job Post
		jobs.add(new JobPosts(10, "Cloud Architect", "Design and implement cloud infrastructure solutions", 6,
				List.of("Cloud Computing", "AWS", "Azure", "Google Cloud")));

		// Job Post 11
		jobs.add(new JobPosts(11, "Software Tester", "Ensure software quality through testing and validation", 3,
				List.of("Testing", "JUnit", "Selenium", "TestNG")));

		// Job Post 12
		jobs.add(new JobPosts(12, "React Native Developer",
				"Develop cross-platform mobile applications using React Native", 2,
				List.of("React Native", "JavaScript", "Mobile App Development")));

		// Job Post 13
		jobs.add(new JobPosts(13, "Business Analyst", "Analyze business processes and recommend improvements", 4,
				List.of("Business Analysis", "Requirements Gathering", "Process Modeling")));

		// Job Post 14
		jobs.add(new JobPosts(14, "Embedded Systems Engineer",
				"Design and develop embedded systems for hardware applications", 5,
				List.of("Embedded Systems", "C/C++", "Microcontrollers", "RTOS")));

		// Job Post 15
		jobs.add(new JobPosts(15, "Content Writer",
		...
		// Job Post 16
		jobs.add(new JobPosts(16, "Business Intelligence Analyst",
				"Utilize data to provide insights and support decision-making", 4,
				List.of("Business Intelligence", "SQL", "Data Warehousing", "Tableau")));

		// Job Post 17
		jobs.add(new JobPosts(17, "UX Researcher", "Conduct user research to inform the design process", 3,
				List.of("User Research", "Usability Testing", "Human-Computer Interaction")));

		// Job Post 18
		jobs
				.add(new JobPosts(18, "Backend Developer", "Build server-side logic and databases for web applications",
						4, List.of("Java", "Spring", "Node.js", "MongoDB")));

		// Job Post 19
		jobs.add(new JobPosts(19, "Game Developer", "Create and optimize games for various platforms", 3,
				List.of("Game Development", "Unity", "C#", "3D Modeling")));

		// Job Post 20
		jobs
				.add(new JobPosts(20, "IT Project Manager", "Lead and manage IT projects from initiation to completion",
						6, List.of("Project Management", "Agile", "Scrum", "Risk Management")));

	}
	
//	List<JobPost> jobs = new ArrayList<>(Arrays.asList(
//			new JobPost(1,"Java developer","Must have good experience in java development",3,List.of("Core Java", "J2EE", "Spring Boot", "Hibernate")),
//			new JobPost(2,"Python developer","Must have good experience in Python developer",1,List.of("Python", "Django")),
//			new JobPost(3,"SQL developer","Must have good experience in SQL developer",4,List.of("MySQL", "NoSQL", "Databases")),
//			new JobPost(4,"Front end developer","Must have good experience in Front end developer",5,List.of("HTML", "CSS", "JavaScript", "ReactJS")),
//			new JobPost(5,"Back end developer","Must have good experience in Back end developer",8,List.of("Core Java", "Rest", "Microservices"))
//	));

	// ****************************************************************************

	// method to return all JobPosts
	public List<JobPosts> returnAllJobPosts() {
		return jobs;
	}

	// method to save a job post object into arrayList
	public void addJobPost(JobPosts job) {
		jobs.add(job);
//		for(JobPost j:jobs) {
